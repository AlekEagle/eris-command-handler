...
class Command {
  ...
  permissionCheck(msg) {
    ...
    if (
      ...
      typeof this.requirements.custom === 'function'
    ) {
      req = true;
    ...
    const keys =
      typeof this.requirements.permissions === 'function'
        ? Object.keys(this.requirements.permissions(msg))
        : Object.keys(this.requirements.permissions);
    if (keys.length > 0) {
      req = true;
